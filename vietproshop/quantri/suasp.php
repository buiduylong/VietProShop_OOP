...
if(isset($_POST['submit'])){
    ...
    if (isset($ten_sp) && isset($gia_sp) && isset($bao_hanh) && isset($phu_kien) && isset($tinh_trang) && isset($khuyen_mai) && isset($trang_thai) && isset($chi_tiet_sp) && isset($dac_biet)) {
        ...
        $sql="UPDATE sanpham SET ten_sp='$ten_sp', gia_sp='$gia_sp', bao_hanh='$bao_hanh', phu_kien='$phu_kien', tinh_trang='$tinh_trang', khuyen_mai='$khuyen_mai', trang_thai='$trang_thai', chi_tiet_sp='$chi_tiet_sp', dac_biet='$dac_biet', anh_sp='$anh_sp', id_dm='$id_dm' WHERE id_sp=$id_sp";
        $query = mysqli_query($conn, $sql);
