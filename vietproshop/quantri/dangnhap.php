...
if(isset($_POST["submit"])){
    ...
    if(isset($email)&&isset($mk)){
        $quyen = "SELECT * FROM thanhvien WHERE email='$email' AND mat_khau='$mk' AND quyen_truy_cap=2";
        $query2=mysqli_query($conn,$quyen);
        ...
        if($rows2>0)
        {
            ...
            $sql="SELECT * FROM thanhvien WHERE email='$email' AND mat_khau='$mk' AND quyen_truy_cap=1";
                    ...
                    <div class="panel-body">
                        ...
                        <form method="post" role="form">
                            <fieldset>
                                ...
                                <a href="../index.php"><input value="Trang chủ" class="btn btn-primary"></a>					
                            </fieldset>
                        </form>
                        <?php
                        }
