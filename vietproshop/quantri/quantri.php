    ...
    <body>
        ...
        <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
            ...
            <ul class="nav menu">
                ...
                <li class="parent ">
                    <a href="quantri.php?page_layout=danhsachthanhvien">
            ...
            if(isset($_GET["page_layout"])){
                switch ($_GET["page_layout"]) {
                    ...
                    case 'suadm':include_once './suadm.php';                
                        break;          
                    case 'danhsachthanhvien':include_once './danhsachthanhvien.php';                
                        break;
                    ...
                    case 'xoathanhvien':include_once './xoathanhvien.php';                
                        break;
                    case 'danhsachbinhluan':include_once './danhsachbinhluan.php';                
                        break;  
                    case 'suabinhluan':include_once './suabinhluan.php';                
                        break;
                    case 'xoabinhluan':include_once './xoabinhluan.php';                
                        break;  
                }
            }
            else{
