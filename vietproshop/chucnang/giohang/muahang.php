...
// Danh sách Sản phẩm đã mua
        ...
        // Phải chỉnh sửa lại
        $mailer->Username = "nhokkononline96@gmail.com"; // GMAIL username
        $mailer->Password = "longcoi1290"; // GMAIL password
        $mailer->AddAddress($email, $ten); //email người nhận
        $mailer->AddCC("nhokkononline96@gmail.com", "Admin Vietpro Shop"); // gửi thêm một email cho Admin
        // Chuẩn bị gửi thư nào
        $mailer->FromName = 'Vietpro Shop'; // tên người gửi
        $mailer->From = 'nhokkononline96@gmail.com'; // mail người gửi
